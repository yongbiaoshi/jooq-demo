...
import com.example.jq.sakila.tables.records.FilmListRecord;
...
public class FilmList extends TableImpl<FilmListRecord> {
    ...
    private static final long serialVersionUID = 610464914;
     ...
     */
    public final TableField<FilmListRecord, FilmListRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR(5).defaultValue(org.jooq.impl.DSL.inline("G", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.example.jq.sakila.enums.FilmListRating.class), this, "");
