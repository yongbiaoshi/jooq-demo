...
import com.example.jq.sakila.tables.records.NicerButSlowerFilmListRecord;
...
public class NicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
    ...
    private static final long serialVersionUID = -910419734;
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, NicerButSlowerFilmListRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR(5).defaultValue(org.jooq.impl.DSL.inline("G", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.example.jq.sakila.enums.NicerButSlowerFilmListRating.class), this, "");
