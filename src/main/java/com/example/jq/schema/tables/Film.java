...
public class Film extends TableImpl<FilmRecord> {
    ...
    private static final long serialVersionUID = 984153471;
     ...
     */
    public final TableField<FilmRecord, FilmRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR(5).defaultValue(org.jooq.impl.DSL.inline("G", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.example.jq.schema.enums.FilmRating.class), this, "");
