...
import com.example.jq.schema.tables.records.NicerButSlowerFilmListRecord;
...
public class NicerButSlowerFilmList extends TableImpl<NicerButSlowerFilmListRecord> {
    ...
    private static final long serialVersionUID = -1901677078;
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, Short> FID = createField("FID", org.jooq.impl.SQLDataType.SMALLINT.defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.SMALLINT)), this, "");
     ...
     */
    public final TableField<NicerButSlowerFilmListRecord, NicerButSlowerFilmListRating> RATING = createField("rating", org.jooq.impl.SQLDataType.VARCHAR(5).defaultValue(org.jooq.impl.DSL.inline("G", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.example.jq.schema.enums.NicerButSlowerFilmListRating.class), this, "");
